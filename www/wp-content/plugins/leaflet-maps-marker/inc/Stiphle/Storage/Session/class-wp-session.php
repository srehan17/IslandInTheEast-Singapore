 ...
 * Last commit included: May 31, 2016 - Merge pull request #37 from julien731/patch-1
 * PR included additionally:
 * - https://github.com/ericmann/wp-session-manager/pull/31
 * - https://github.com/ericmann/wp-session-manager/pull/34
 *
 ...
 * @since   3.7.0
 */
final class LMM_WP_Session extends LMM_Recursive_ArrayAccess {
	/**
	...
	protected function __construct() {
		if ( isset( $_COOKIE[WP_SESSION_COOKIE] ) ) {
			...
			$this->session_id = LMM_WP_Session_Utils::generate_id();
			$this->set_expiration();
		}
