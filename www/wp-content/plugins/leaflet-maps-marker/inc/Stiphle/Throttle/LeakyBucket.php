 ...
 */
class LMM_LeakyBucket implements ThrottleInterface
{
    /**
    ...
    {
        $lastRequest = $this->getLastRequest($key)? $this->getLastRequest($key): 0;
        $lastRatio   = $this->getLastRatio($key)? $this->getLastRatio($key): 0;
