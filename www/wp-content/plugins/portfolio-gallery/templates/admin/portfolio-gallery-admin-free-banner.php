...
<div class="free_version_banner" <?php if( isset($_COOKIE['portfolioGalleryBannerShow']) && $_COOKIE['portfolioGalleryBannerShow'] == "no" ) echo 'style="display:none"'; ?> >
    ...
    <a href="http://huge-it.com" target="_blank"><img class="huge_it_logo" src="<?php echo esc_attr(PORTFOLIO_GALLERY_IMAGES_URL.'/admin_images/Huge-It-logo.png'); ?>"/></a>
    ...
    <div class="hg_view_plugins_block">
        ...
        <a target="_blank"  href="http://huge-it.com/wordpress-plugins-portfolio-gallery-demo/">Full Demo</a>
